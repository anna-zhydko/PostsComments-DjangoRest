...
class NewsPost(models.Model):
    ...
    amount_of_upvotes = models.IntegerField(verbose_name='amount of upvotes', default=0)
...
class Upvote(models.Model):
    ...
    news_post = models.ForeignKey(NewsPost, verbose_name='news_post', on_delete=models.CASCADE)
